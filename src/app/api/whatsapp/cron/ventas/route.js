...
const MANAGER_PHRASES = {
  'sebas semental': [
    "🔥 *{nombre}* rayando a la competencia como a sus tatuajes en *{tienda}*.",
    "🎨 *{nombre}* inyectando tinta y billetes en *{tienda}*. Puro arte.",
    "🐉 Con más tickets que tatuajes, *{nombre}* anda con todo en *{tienda}*.",
    "⚡ Puro voltaje y aguijones. *{nombre}* tatuando su marca en *{tienda}*.",
    "🔥 Tinta fresca y billetes nuevos. *{nombre}* comandando *{tienda}*.",
    "💀 El maestro de la tinta *{nombre}* imponiendo ley en *{tienda}*.",
    "😎 Ni con aguja duele tanto como el éxito de *{nombre}* en *{tienda}*.",
    "⚡ Tatuajes, rock y exceso de ventas. *{nombre}* domina *{tienda}*.",
    "💉 Más letal que la tinta negra, *{nombre}* marcando el paso en *{tienda}*.",
    "🤘 Al estilo oscuro y directo, *{nombre}* se lleva *{tienda}*.",
    "🐉 Despertó la bestia tatuada. *{nombre}* en *{tienda}* lidera hoy.",
    "🔪 Cortando parejo, *{nombre}* afiló las ventas en *{tienda}*.",
    "🔥 Rock and roll y dinero en caja. *{nombre}* la rompe en *{tienda}*.",
    "🎨 El lienzo es *{tienda}* y *{nombre}* la está pintando de verde billo.",
    "💣 Cuidado con los tatuajes, *{nombre}* vino a aniquilar en *{tienda}*.",
    "💉 Directo a la vena. Las ventas de *{nombre}* en *{tienda}* no paran.",
    "😎 La vida es un tatuaje y *{nombre}* la vive cobrando en *{tienda}*.",
    "⚡ Inyectando su estilo agresivo. *{nombre}* aplasta desde *{tienda}*.",
    "💀 El rey de la tinta *{nombre}* sin piedad en *{tienda}*.",
    "🤘 Menos charla, más tinta y ventas. *{nombre}* facturando en *{tienda}*.",
    "🔥 *{nombre}* marcando el territorio en *{tienda}* a punta de aguja.",
    "🐉 Tatuajes brillando, billetes cayendo. Aplausos para *{nombre}* en *{tienda}*.",
    "⚡ 100% actitud. 100% ventas. *{nombre}* y su tinta arrasan *{tienda}*.",
    "🎨 Pintando números insanos, *{nombre}* lidera *{tienda}*.",
    "💀 Estilo rudo, caja llena. *{nombre}* imponiendo en *{tienda}*.",
    "🚀 Nadie frena a la aguja de *{nombre}* sumando en *{tienda}*.",
    "💉 Tatuado y victorioso. *{nombre}* es la fiera de *{tienda}*."
  ],
  'abraham': [
    "⚽ ¡Modo ataque de *{nombre}*! Sudando la camiseta a lo Santos Laguna en *{tienda}*.",
    "🛡️ *{nombre}* defendiendo la localía en *{tienda}* como guerrero de la Comarca.",
    "⚔️ Modo 'Santos Laguna'. *{nombre}* le pone técnica y corazón en *{tienda}*.",
    "🟢⚪ Sacando la casta lagunera, *{nombre}* es el campeón de *{tienda}*.",
    "⚽ Tiro libre y al ángulo. *{nombre}* golea desde *{tienda}*.",
    "🛡️ Un verdadero guerrero de la cancha. *{nombre}* impenetrable en *{tienda}*.",
    "⚽ ¡Ponte la del Santos! *{nombre}* sumando como goleador en *{tienda}*.",
    "🔥 El Estadio Corona grita por *{nombre}* tras arrasar en *{tienda}*.",
    "⚽ Pase de oro y gol. *{nombre}* facturando en *{tienda}*.",
    "🛡️ Con alma de guerrero lagunero. *{nombre}* defiende su *{tienda}*.",
    "🟢⚪ Goleador absoluto de la temporada, *{nombre}* brillando en *{tienda}*.",
    "⚔️ Al más puro estilo de la Comarca, *{nombre}* arrasa en *{tienda}*.",
    "🥅 Nadie le ataja las ventas a *{nombre}* en *{tienda}*. ¡Goooool!",
    "🥇 El trofeo de hoy en la Comarca es para *{nombre}* en *{tienda}*.",
    "⚽ ¡Juegazo de *{nombre}*! Llevándose la victoria en *{tienda}*.",
    "🛡️ Cerrando filas y vendiendo como cra. *{nombre}* es la muralla de *{tienda}*.",
    "🟢⚪ Pasión albiverde. Así suma *{nombre}* de tickets en *{tienda}*.",
    "⚽ El crack de la jornada indiscutible: *{nombre}* en *{tienda}*.",
    "⚔️ Sacrificio, sudor y ventas. *{nombre}* dejando todo en *{tienda}*.",
    "🏟️ ¡La afición de *{tienda}* de pie para *{nombre}*!",
    "⚽ Otro hat-trick financiero de *{nombre}* en *{tienda}*.",
    "🛡️ Con el escudo bien puesto. *{nombre}* defendiendo *{tienda}*.",
    "🔥 Remate dentro del área de *{nombre}* para ganar en *{tienda}*.",
    "🟢⚪ Santo orgullo. *{nombre}* demostrando en *{tienda}* quién manda."
  ],
  'lidia': [
    "🙄 La indiscutible 'MEJOR EMPLEADA DE LA HISTORIA': *{nombre}* sigue facturando en *{tienda}*. Pasen a felicitarla.",
    "✨ Oh salvadora de El Diablito, la 'empleada del siglo' *{nombre}* se dignó a cobrar en *{tienda}*. Qué barbaridad.",
    "👑 Tapete rojo para *{nombre}*. La 'mejor del condado' nos honró facturando en *{tienda}*. Nótese el sarcasmo.",
    "💅 Cuidado, abrió paso la intocable *{nombre}*. Dominando *{tienda}*. Mucho respeto.",
    "🙄 Demos gracias a que *{nombre}* amaneció de buenas y vendió en *{tienda}*. Milagro del cielo.",
    "✨ Haciéndonos el grandísimo favor de cobrar... La grandiosa *{nombre}* en *{tienda}*.",
    "💅 Brillos, glamour y cero ganas de aguantarnos: *{nombre}* arranca tickets en *{tienda}*.",
    "😂 Sin ella quebraríamos. Obvio. *{nombre}* soportó *{tienda}* y vendió bien.",
    "👑 Una reverencia para *{nombre}* por favor. Nos salvó de la ruina desde *{tienda}*.",
    "🙄 'Soy demasiado buena para esta tienda'. - *{nombre}* desde *{tienda}*.",
    "✨ Iluminando con su soberbia *{tienda}*. Bendita *{nombre}*.",
    "👑 No la miren fijo que deslumbra. *{nombre}* barrió con las ventas en *{tienda}*.",
    "🙄 Hagan un altar a *{nombre}* en *{tienda}* por sus milagros de hoy.",
    "😂 Se rompió una uña pero logró vender. Guerrera implacable *{nombre}* en *{tienda}*.",
    "✨ La flor más bella y humilde de *{tienda}* es... obviamente *{nombre}*.",
    "👑 Con aire de grandeza y 0 humildad, *{nombre}* comandó *{tienda}*.",
    "🙄 Suponemos que mereces un Óscar, *{nombre}*. Tremenda labor en *{tienda}*.",
    "😂 Ojalá no se haya cansado mucho de teclear. *{nombre}* ganando en *{tienda}*.",
    "✨ 'Corten, soy la estrella'. *{nombre}* siendo diva en *{tienda}*.",
    "👑 Realeza indiscutible. Reina de la caja en *{tienda}*. Sí, claro, *{nombre}*.",
    "🙄 Se va a herniar de tanto vender tamaña leyenda... *{nombre}* en *{tienda}*.",
    "💅 Niégalo si quieres, pero *{nombre}* se siente patrona en *{tienda}*.",
    "✨ Con peinado intacto y ventas altas, *{nombre}* se luce en *{tienda}*.",
    "👑 ¿Le mandamos chofer? La excelentísima *{nombre}* facturando en *{tienda}*."
  ]
};

const GENERIC_PHRASES = [
  "💪 ¡Vamos banda! *{nombre}* aportando todo el poder a *{tienda}*.",
  "⚡ *{nombre}* dándole con tubo en *{tienda}*. ¡A darle!",
  "🚀 Imparable nivel de *{nombre}* defendiendo *{tienda}*.",
  "🔥 Metiendo nitro. *{nombre}* anda on-fire en *{tienda}*.",
  "🎯 Precisión absoluta de *{nombre}* sumando en *{tienda}*.",
  "💥 ¡Boom! *{nombre}* reventando expectativas en *{tienda}*.",
  "💎 Joya de desempeño de *{nombre}* hoy en *{tienda}*.",
  "⚡ Electrocutando a la competencia. Grande *{nombre}* en *{tienda}*.",
  "🥇 Sacando la casta y el orgullo. Bien por *{nombre}* en *{tienda}*.",
  "🔥 Sudando la camiseta de El Diablito. *{nombre}* en *{tienda}*.",
  "🚀 Con una marcha más que el resto. *{nombre}* acelerando *{tienda}*.",
  "🎯 Clavó los números exactos. *{nombre}* rifándose en *{tienda}*.",
  "💥 Cuidado con la onda expansiva de *{nombre}* en *{tienda}*.",
  "💎 Calidad de ventas innegable de *{nombre}* en *{tienda}*.",
  "⚡ ¡Zapatazo financiero! *{nombre}* cerrando con tubo en *{tienda}*.",
  "🥇 Primer nivel y nada de conformismo. *{nombre}* operando *{tienda}*.",
  "🔥 *{nombre}* dejó el alma y los billetes en *{tienda}*.",
  "🚀 ¡Hasta el cielo! *{nombre}* no tiene freno en *{tienda}*.",
  "🎯 Ojo clínico para vender de *{nombre}* en *{tienda}*.",
  "💥 Demolición total de ventas a cargo de *{nombre}* en *{tienda}*.",
  "💎 Diamante en bruto facturando a tope. Ese es *{nombre}* en *{tienda}*."
];

const STORE_ONLY_PHRASES = [
  "🛒 *{tienda}* sumando y sumando al contador global.",
  "🚀 El equipo de *{tienda}* firme en el campo de batalla.",
  "🔥 ¡Calentando motores! *{tienda}* hizo valer su presencia.",
  "⚡ Alto voltaje directo desde *{tienda}*.",
  "💥 Máquina de hacer dinero: *{tienda}* operando sin piedad.",
  "💎 Brillo absoluto en los números de *{tienda}*.",
  "🎯 Dando en el blanco financiero. Extraordinario *{tienda}*.",
  "🥇 Peleando cada ticket a muerte en *{tienda}*.",
  "🚀 Propulsión máxima. *{tienda}* elevando las ganancias global.",
  "🔥 Sin miedo al éxito. *{tienda}* arrasó como pan caliente.",
  "⚡ Resistencia y constancia definiendo a *{tienda}* hoy.",
  "💥 Cerrando operaciones con puro poder explosivo en *{tienda}*."
];
